                ...
                <div className='md:flex-0 mx-auto flex w-full max-w-full shrink-0 flex-col px-3 md:w-7/12 lg:mx-0 lg:w-5/12 xl:w-4/12'>
                  <div className='lg:py4 dark:bg-gray-950 relative flex min-w-0 flex-col break-words rounded-2xl border-0 bg-transparent bg-clip-border shadow-none'>
                    <div className='mb-0 p-6 pb-0'>
                      ...
                      <p className='mb-0'>
                        Create your account and leave your cloud infrastructure
                        to us
                      </p>
                    </div>
                    <div className='flex-auto p-6'>
                      <form role='form'>
                        ...
                        <div className='min-h-6 mb-0.5 block px-7 text-center'>
                          <label
                            className='mb-2 ml-1 cursor-pointer text-sm font-normal text-slate-700'
                          ...
                          >
                            ...
                            >
                              By creating a user account, I accept all the rules
                              of the service
                            </a>{' '}
                          </label>
                        </div>
